...
ifdef LLAMA_CUBLAS
	MK_CPPFLAGS  += -DGGML_USE_CUBLAS -I/usr/local/cuda-12/include -I/opt/cuda-12/include -I$(CUDA_PATH)/targets/x86_64-linux/include
	MK_LDFLAGS   += -lcublas -lculibos -lcudart -lcublasLt -lpthread -ldl -lrt -L/usr/local/cuda-12/lib64 -L/opt/cuda-12/lib64 -L$(CUDA_PATH)/targets/x86_64-linux/lib
	OBJS         += ggml-cuda.o
